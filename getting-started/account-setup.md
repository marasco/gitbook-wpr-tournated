...
1. Email [info@padelusa.org](mailto:info@padelusa.org) & [tduspa@worldpadelrating.com](mailto:tduspa@worldpadelrating.com) with:
...
2. *Connect your Stripe account to the TMS, and email info@padelusa.org & tduspa@worldpadelrating.com to notify when done. (*Required only once, for the first tournament you run.):
